...
return new class extends Migration
{
    ...
    {
        Schema::create('san_shop_varer', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('pris')->nullable()->default(0)->comment('pris i øre');
            ...
            $table->float('netto_indkobspris-dkr')->nullable();
    ...
    {
        Schema::dropIfExists('san_shop_varer');
    }
};
