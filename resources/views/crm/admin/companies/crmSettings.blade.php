        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="head-label text-left">
                <h6 class="offcanvas-title d-flex align-items-center">
                    <span class="me-1 fs-5"><i class="bx bx-cog"></i></span><span class="pt-1">CRM Settings</span>
                </h6>
            </div>
        </div>
    </div> 
        ...
        <div class="border rounded">
            <form id="privilegesForm">
                ...
                <div class="card-header flex-column flex-md-row mt-1">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <div class="head-label text-left mt-1">
                            <h6 class="card-title mb-0">Privileges
                            </h6>
                        </div>
                        <div class="text-end mt-2">
                            <div class="input-group position-relative w-auto float-end">
                                <input type="text" class="form-control rounded-1" id="searchPrivileges" placeholder="Search" aria-label="Search privileges" style="padding-left: 40px;">
                ...
                <div class="card-body">
                    ...
                    <div class="text-end">
                        <button type="button" class="btn btn-light" id="crmResetPrivileges">Reset</button>
                        <button type="button" class="btn btn-primary saveCrmPrivileges" disabled="disabled">Save Privileges</button>
                    </div>
                </div>
            </form>
        </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" style="width:auto;">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id=""><i class="bx bx-edit mx-1"></i>Add Role and Privileges</h5>
        <button type="button" class="btn-close crm_new_privilege_close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
        ...
        <form id="roleregisterForm">
            ...
            <div class="row g-4">
                ...
                <div class="text-end mt-5">
                    <button type="button" class="btn btn-label-secondary crm_new_privilege_close  btn-light" data-bs-dismiss="offcanvas" aria-label="Close">Cancel</button>
                    <button type="button" class="btn btn-primary SubmitCrmCreateRoleForm" data-companyid='{{Crypt::encrypt($company_details->id)}}'>Add Role</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="crmUpdateOffcanvasRight" aria-labelledby="offcanvasRightLabel" style="width:auto;">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id=""><i class="bx bx-edit mx-1"></i>Edit Role and Privileges</h5>
        <button type="button" class="btn-close crm_update_privilege_close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
        <form id="update_Crm_roleregisterForm">
            @csrf
            <div class="row g-2">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <input type="text" class="form-control" name="update_role" placeholder="Enter Role Name"
                        aria-label="role" />
                </div>
            </div>
            <div class="row g-4">
                <div class="card-body ">
                    <div class="table-responsive">
                        <table class="table table-borderless" id="update_role_privilege_table">
                            <thead class="table-light">
                                <tr>
                                    <th class="text-nowrap">Modules</th>
                                    <th class="text-nowrap text-center">All</th>
                ...
                <div class="text-end mt-5">
                    <button type="button" class="btn btn-label-secondary crm_update_privilege_close btn-light" data-bs-dismiss="offcanvas" aria-label="Close">Cancel</button>
                    <button type="button" class="btn btn-primary SubmitCrmUpdateRoleForm" data-companyid='{{Crypt::encrypt($company_details->id)}}'>Update Role</button>
                </div>
            </div>
        </form>
    </div>
